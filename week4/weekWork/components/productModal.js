        ...
        <div class="row">
          <div class="col-sm-4">
            <div class="mb-3">
              ...
              <input type="text" v-model="tempProduct.imageUrl" class="form-control mb-2" placeholder="請輸入圖片連結">
              <img class="img-fluid" :src="tempProduct.imageUrl">
            </div>
            <h3 class="mb-3">多圖新增</h3>
            <!-- 判斷 tempProduct.imagesUrl 是一個陣列 -->
            <template v-if="Array.isArray(tempProduct.imagesUrl)">
              <div class="mb-1" v-for="(img, key) in tempProduct.imagesUrl" :key="key + 12">
                <div class="mb-3">
